...
class CharBody {
  constructor(owner, basePos, attributes) {
    ...
    // arms
    this.armsCentre = {x: this.basePos.x - 0.85 * this.leanForward, y: this.basePos.y-this.height*0.85 + 0.85*this.leanForward*0.25}
    ...
    this.arms[1].graphics.setDepth(2)
